  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <section className="bg-[#1b3462] text-white flex flex-col items-center justify-center relative" style={{ height: '220px' }}>
          <div className="text-center" style={{ marginTop: '52px', marginBottom: '26px' }}>
