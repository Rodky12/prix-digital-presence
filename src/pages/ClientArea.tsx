  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <section className="bg-[#1b3462] text-white flex flex-col items-center justify-center relative" style={{ height: '200px' }}>
          <div className="text-center" style={{ marginTop: '48px', marginBottom: '24px' }}>
